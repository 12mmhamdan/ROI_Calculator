...
class Main:
    ...
    while True:
        if response == 'y':
            clear_output()
            print(f"Next, we will calculate your cash flow.")
            time.sleep(3)
            clear_output()
            break
        elif response == 'n':
            clear_output()
            print("Sorry. I'm still not perfect...")
            total_expense = hello.expense()
            print('\n')
            print(f"You've entered a total expense of ${total_expense:.2f}. Does that look right? ")
            response = input("Does that look right? Please choose (y/n). ")
            ...
            time.sleep(2)
            clear_output()
            print(f"You've entered a total expense of ${total_expense:.2f}.")
            response = input("Does that look right? Please choose (y/n). ")
            print('\n')
            continue
    cash_flow_value = float(hello.cash_flow(total_income, total_expense))
    print(f"Based on the numbers you have entered, your cashflow is ${cash_flow_value:.2f}")
